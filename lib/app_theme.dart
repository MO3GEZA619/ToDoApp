...
class AppTheme {
  ...
  static ThemeData lightTheme = ThemeData(
      ...
      floatingActionButtonTheme: FloatingActionButtonThemeData(backgroundColor: lightBlue)
      ,textTheme: TextTheme(titleLarge:TextStyle(fontWeight: FontWeight.bold,fontSize:20,color: white),
       titleMedium: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: black),
